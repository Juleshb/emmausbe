 ...
 const mailOptions2 = {
  ...
  html: `
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
        ...
        <p>In the meantime, if you have any urgent concerns or additional information to share, please feel free to reach out to us directly at +250 787 172 920 .</p>
        <p>Thank you for your patience and interest in Emmaus Hostel. We look forward to assisting you!</p>
        <br>
        <p>Best regards,</p>
        <p>Emmaus Hostel<br>+250 787 172 920</p>
